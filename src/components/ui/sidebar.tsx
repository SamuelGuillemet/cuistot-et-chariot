...
import { useSidebarMutationOptions } from '@/lib/server-queries';
...
function SidebarProvider({
  ...
  const sidebarMutation = useMutation(useSidebarMutationOptions());
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Use TanStack mutation to persist sidebar state
      sidebarMutation.mutate(openState);
    },
    [setOpenProp, open, sidebarMutation],
  );
